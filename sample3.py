...
class computer:
    ...
    def _init(self, cpu, ram):   #initializing variables __int_ prints automatically no need of calling it
        self.cpu = cpu
        self.ram = ram
...
# variables
# variables defined in the _init_ are instance variables
# variables defined outside the _init_ are class variales


class car:

    #variables defined outsode of the _init_ class variables
...
class B:       #child/sub class inhertting all features of A
    ...
    def _init_(self):
        super()._init_()    #super is a method or keyword you can access all the features of the parent  class   
        print("in B init")
...
class C(A,B):
    ...
    def _init_(self):
        super()._init_()     #super accesss all elements of super class
        print("in C init")
...
# a2 = C()    # constructor of A calls a method _init_
...
b = 3
# print(a+b)
# print(int._add(a,b))  # int.add() method also adds the numbers
# # print(str._add_(a,b))  # str for string the strings are concatinated
# print(int._sub_(a,b))   #subtracts a, b
# print(int._mul_(a, b))   #multiplies a, b
...
std = student("burma","30")
print(std.studentname)   #to show the variables use   _object._class_variable
